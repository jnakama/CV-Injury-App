...
=end
    ...
    params.require(:injury).permit(:sport, :name, :exposure, :date, :reportnotes, :side, :part, :injurytype, :symptoms, :injurynotes, :immediatetreatment, :returndate, :returned, :treatmentnotes, :attachment);
    end
